    ...
    <div className='bg-[#FCFCFC] shadow-md shadow-slate-400 p-3 h-full'>
        ...
        <div className='flex  gap-5 items-center ' >
            ...
            <ul className='text-slate-500 text-[13px] px-3'>
                <li className='flex items-center'><a href="#"><span className=" text-xl pr-1">▸</span>আর্কিটেকচার এবং ইন্টেরিয়র ডিজাইন টেকনোলজি</a></li>
                ...
                <li className='flex items-center'><a href="#"><span className=" text-xl pr-1">▸</span>রেফ্রিজারেশন এবং এয়ার কন্ডিশনার টেকনোলজি</a></li>
