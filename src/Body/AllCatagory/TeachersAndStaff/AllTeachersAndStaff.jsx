    ...
    <div className="md:grid grid-cols-2 gap-5 ">
      ...
      <div className="flex flex-col items-center rounded-lg shadow-md shadow-green-400 mb-5">
        ...
        <div className="card-body justify-end items-center w-full text-center">
          <h2 className="card-title">Computer Science Technology (CST)</h2>
            <Link onClick={handleLinkClick} className=" w-full py-2 hover:text-white bg-green-400 font-semibold rounded-lg hover:bg-green-500" to={"/Computer"}>Teacher</Link>
        </div>
      </div>
      {/* architecture */}
      <div className="flex flex-col justify-between items-center rounded-lg shadow-md shadow-green-400 mb-5">
        ...
        <div className="card-body justify-end items-center w-full text-center">
          ...
          <Link onClick={handleLinkClick} className=" w-full py-2 hover:text-white bg-green-400 font-semibold rounded-lg hover:bg-green-500" to={"/AIDT"}>Teacher</Link>
        </div>
      </div>
      {/* Food */}
      <div className="flex flex-col justify-between items-center rounded-lg shadow-md shadow-green-400 mb-5">
        ...
        <div className="card-body justify-end items-center w-full text-center">
          ...
          <Link onClick={handleLinkClick} className=" w-full py-2 hover:text-white bg-green-400 font-semibold rounded-lg hover:bg-green-500" to={"/Food"}>Teacher</Link>
        </div>
      </div>
      {/* Mechatronics */}
      <div className="flex flex-col justify-between items-center rounded-lg shadow-md shadow-green-400 mb-5">
        ...
        <div className="card-body justify-end items-center w-full text-center">
          ...
          <Link onClick={handleLinkClick} className=" w-full py-2 hover:text-white bg-green-400 font-semibold rounded-lg hover:bg-green-500" to={"/Mechatronics"}>Teacher</Link>
        </div>
      </div>
      {/* RAC */}
      <div className="flex flex-col justify-between items-center rounded-lg shadow-md shadow-green-400 mb-5">
        ...
        <div className="card-body justify-end items-center w-full text-center">
          ...
          <Link onClick={handleLinkClick} className=" w-full py-2 hover:text-white bg-green-400 font-semibold rounded-lg hover:bg-green-500" to={"/RAC"}>Teacher</Link>
        </div>
      </div>
      {/* NonTech */}
      <div className="flex flex-col justify-between items-center rounded-lg shadow-md shadow-green-400 mb-5">
        ...
        <div className="card-body justify-end items-center w-full text-center">
          ...
          <Link onClick={handleLinkClick} className=" w-full py-2 hover:text-white bg-green-400 font-semibold rounded-lg hover:bg-green-500" to={"/NonTech"}>Teacher</Link>
        </div>
      </div>
      {/* Staff */}
      <div className="flex flex-col justify-between items-center rounded-lg shadow-md shadow-green-400 mb-5">
        ...
        <div className="card-body justify-end items-center w-full text-center">
          ...
          <Link onClick={handleLinkClick} className=" w-full py-2 hover:text-white bg-green-400 font-semibold rounded-lg hover:bg-green-500" to={"/staffes"}>Members</Link>
        </div>
