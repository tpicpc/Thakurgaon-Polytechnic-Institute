...
export default function Header() {
  return (
    <div className="bg-[#2F9014] flex justify-between items-center py-4 px-2 border-b-4 border-[#8AD024]">
        ...
        <div className="flex gap-3">
            <input className=" outline-sky-500 outline-[1px] border-none rounded-md px-2 text-sm font-semibold" type="text" placeholder="Search anything..." />
